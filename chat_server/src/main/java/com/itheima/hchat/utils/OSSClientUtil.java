...
public class OSSClientUtil {
    ...
    private static String returnUrl =  "http://netty-chat.oss-cn-beijing.aliyuncs.com/";
...
//                return spilt1[0];
    ...
    public String uploadFileByPath(String filePath){
        ...
        // 阿里云主账号AccessKey拥有所有API的访问权限，风险很高。强烈建议您创建并使用RAM账号进行API访问或日常运维，请登录 https://ram.console.aliyun.com 创建RAM账号。
                String MyAccessKeyId = accessKeyId;
                String MyAccessKeySecret = accessKeySecret;
        String[] splits = filePath.split("/");
        String ObjectName = "Avatar/"+splits[splits.length-1];
        // 创建OSSClient实例。
        ...
        // 关闭OSSClient。
                ossClient.shutdown();
        return returnUrl+"Avatar/"+splits[splits.length-1];
    }
